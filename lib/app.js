...
module.exports = function (cb) {
    ...
    var server = http.createServer(function (req, res) {
      try {
          ...
          switch (req.url) {
              case '/kicktest':
                require('../routes/kicktest')(req, res);
                break;
              case '/version':
    ...
    server.timeout = 300000; // MAX 5 minutes to complete all tests
    server.listen(port, function () {
        ...
        if (cb) {
            ...
            console.log("start the test job");
            //require('./runtest.js')(); //start the test job
            /*
